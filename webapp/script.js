...
const TRANSLATIONS = {
    UZ: {
        ...
        label_rules_btn: "Tizim qoidalari",
        rule_correct: "To‘g‘ri javob",
        rule_correct_desc: "+5 ball",
        rule_speed: "Tezlik bonusi (3s)",
        rule_speed_desc: "+10 ball",
        rule_streak: "Seriya (10 ta)",
        rule_streak_desc: "+10 ball",
        rule_wrong: "Noto‘g‘ri javob",
    ...
    EN: {
        ...
        label_rules_btn: "System Rules",
        rule_correct: "Correct Answer",
        rule_correct_desc: "+5 points",
        rule_speed: "Speed Bonus (3s)",
        rule_speed_desc: "+10 points",
        rule_streak: "Streak (every 10)",
        rule_streak_desc: "+10 points",
        rule_wrong: "Wrong Answer",
...
async function init() {
    ...
    const elementsToLocalize = {
        ...
        'rules-modal-title': 'rules_modal_title',
        'rules-close': 'close_btn',
        'label-rules-btn': 'label_rules_btn',
        'perf-history-title': 'results_history',
        'rule-correct-title': 'rule_correct',
        'rule-correct-desc': 'rule_correct_desc',
        'rule-speed-title': 'rule_speed',
        'rule-speed-desc': 'rule_speed_desc',
        'rule-streak-title': 'rule_streak',
        'rule-streak-desc': 'rule_streak_desc',
        'rule-wrong-title': 'rule_wrong',
